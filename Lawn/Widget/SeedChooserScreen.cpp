...
void SeedChooserScreen::MouseWheel(int theDelta)
{
	...
	mScrollAmount -= mBaseScrollSpeed * theDelta; // mScrollAmount += mBaseScrollSpeed * theDelta;
	mScrollAmount -= mScrollAmount * mScrollAccel; // mScrollAmount += mScrollAmount * mScrollAccel;
}
