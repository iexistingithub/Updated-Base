...
ChallengeDefinition gChallengeDefs[NUM_CHALLENGE_MODES] = {
	...
	{ GameMode::GAMEMODE_SURVIVAL_NORMAL_STAGE_6,              5,   ChallengePage::CHALLENGE_PAGE_SURVIVAL,    1,  0,  _S("[SURVIVAL_NIGHT_ROOF_NORMAL]") },
	{ GameMode::GAMEMODE_SURVIVAL_NORMAL_STAGE_7,              5,   ChallengePage::CHALLENGE_PAGE_SURVIVAL,    1,  1,  _S("[SURVIVAL_CAMP_NORMAL]") },
	{ GameMode::GAMEMODE_SURVIVAL_NORMAL_STAGE_8,              5,   ChallengePage::CHALLENGE_PAGE_SURVIVAL,    1,  2,  _S("[SURVIVAL_DOCKS_NORMAL]") },
	{ GameMode::GAMEMODE_SURVIVAL_HARD_STAGE_1,                6,   ChallengePage::CHALLENGE_PAGE_SURVIVAL,    1,  3,  _S("[SURVIVAL_DAY_HARD]") },
	{ GameMode::GAMEMODE_SURVIVAL_HARD_STAGE_2,                7,   ChallengePage::CHALLENGE_PAGE_SURVIVAL,    1,  4,  _S("[SURVIVAL_NIGHT_HARD]") },
	{ GameMode::GAMEMODE_SURVIVAL_HARD_STAGE_3,                8,   ChallengePage::CHALLENGE_PAGE_SURVIVAL,    2,  0,  _S("[SURVIVAL_POOL_HARD]") },
	{ GameMode::GAMEMODE_SURVIVAL_HARD_STAGE_4,                9,   ChallengePage::CHALLENGE_PAGE_SURVIVAL,    2,  1,  _S("[SURVIVAL_FOG_HARD]") },
	{ GameMode::GAMEMODE_SURVIVAL_HARD_STAGE_5,                10,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    2,  2,  _S("[SURVIVAL_ROOF_HARD]") },
	{ GameMode::GAMEMODE_SURVIVAL_HARD_STAGE_6,                11,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    2,  3,  _S("[SURVIVAL_NIGHT_ROOF_HARD]") },
	{ GameMode::GAMEMODE_SURVIVAL_HARD_STAGE_7,                11,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    2,  4,  _S("[SURVIVAL_CAMP_HARD]") },
	{ GameMode::GAMEMODE_SURVIVAL_HARD_STAGE_8,                11,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    3,  0,  _S("[SURVIVAL_DOCKS_HARD]") },
	{ GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_1,             12,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    3,  1,  _S("[SURVIVAL_DAY_ENDLESS]") },
	{ GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_2,             13,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    3,  2,  _S("[SURVIVAL_NIGHT_ENDLESS]") },
	{ GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_3,             14,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    3,  3,  _S("[SURVIVAL_POOL_ENDLESS]") },
	{ GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_4,             15,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    3,  4,  _S("[SURVIVAL_FOG_ENDLESS]") },
	{ GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_5,             16,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    4,  0,  _S("[SURVIVAL_ROOF_ENDLESS]") },
	{ GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_6,             17,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    4,  1,  _S("[SURVIVAL_NIGHT_ROOF_ENDLESS]") },
	{ GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_7,             17,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    4,  2,  _S("[SURVIVAL_CAMP_ENDLESS]") },
	{ GameMode::GAMEMODE_SURVIVAL_ENDLESS_STAGE_8,             17,  ChallengePage::CHALLENGE_PAGE_SURVIVAL,    4,  3,  _S("[SURVIVAL_DOCKS_ENDLESS]") },
	...
	{ GameMode::GAMEMODE_CHALLENGE_ART_CHALLENGE_WALLNUT,      6,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   4,  0,  _S("[ART_CHALLENGE_CLASSIC]") },
	...
	{ GameMode::GAMEMODE_CHALLENGE_ICE,                        6,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   5,  1,  _S("[ICE_LEVEL]") },
	{ GameMode::GAMEMODE_CHALLENGE_ZEN_GARDEN,                 7,   ChallengePage::CHALLENGE_PAGE_LIMBO,       5,  2,  _S("[ZEN_GARDEN]") },
	{ GameMode::GAMEMODE_CHALLENGE_HIGH_GRAVITY,               8,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   5,  2,  _S("[HIGH_GRAVITY]") },
	{ GameMode::GAMEMODE_CHALLENGE_GRAVE_DANGER,               11,  ChallengePage::CHALLENGE_PAGE_CHALLENGE,   5,  3,  _S("[GRAVE_DANGER]") },
	{ GameMode::GAMEMODE_CHALLENGE_SHOVEL,                     10,  ChallengePage::CHALLENGE_PAGE_CHALLENGE,   5,  4,  _S("[CAN_YOU_DIG_IT]") },
	{ GameMode::GAMEMODE_CHALLENGE_SQUIRREL,                   10,  ChallengePage::CHALLENGE_PAGE_CHALLENGE,   6,  2,  _S("Squirrel") },
	{ GameMode::GAMEMODE_CHALLENGE_BUNGEE_BLITZ,               9,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   6,  1,  _S("[BUNGEE_BLITZ]") },
	{ GameMode::GAMEMODE_CHALLENGE_SQUIRREL,                   10,  ChallengePage::CHALLENGE_PAGE_CHALLENGE,   6,  2,  _S("Squirrel") },
	{ GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_3,             0,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   6,  0,  _S("[WAR_AND_PEAS_3]") },
	{ GameMode::GAMEMODE_CHALLENGE_DOCKS,                      22,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   6,  3,  _S("[DOCKS]") },
	{ GameMode::GAMEMODE_CHALLENGE_GARG,                       23,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   6,  4,  _S("[WE_SMASH]") },
	{ GameMode::GAMEMODE_CHALLENGE_ALL,                        29,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   7,  0,  _S("[ALL_TOGETHER]") },
	{ GameMode::GAMEMODE_CHALLENGE_PURPLE,                     24,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   7,  1,  _S("[WE_ARE_PURPLE]") },
	{ GameMode::GAMEMODE_CHALLENGE_MOUNTAIN,                   26,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   7,  2,  _S("[DOWN_WITH_THE_WATERFALL]") },
	{ GameMode::GAMEMODE_CHALLENGE_ATHLETES,                   28,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   7,  3,  _S("[ATHLETES_MARATHON]") },
	{ GameMode::GAMEMODE_CHALLENGE_DEEZNUTS,                   27,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   7,  4,  _S("[TOTALLY_NUTS]") },
	{ GameMode::GAMEMODE_CHALLENGE_PEAR,                       25,   ChallengePage::CHALLENGE_PAGE_CHALLENGE,   8,  0,  _S("[HELLUVA_BOSS_EPISODE]") },
	{ GameMode::GAMEMODE_CHALLENGE_BOH,                        30,  ChallengePage::CHALLENGE_PAGE_CHALLENGE,   8,  1,  _S("[BACKYARD_OF_HAZBIN_HOTEL]") },
	{ GameMode::GAMEMODE_CHALLENGE_RIVER,                      11,  ChallengePage::CHALLENGE_PAGE_CHALLENGE,   8,  2,  _S("[RIVER_EL_MAS_GRANDE]") },
	{ GameMode::GAMEMODE_CHALLENGE_WORKERS,                    11,  ChallengePage::CHALLENGE_PAGE_CHALLENGE,   8,  3,  _S("[SAMEN PAGAME]") },
	...
	{ GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_10,                   11,  ChallengePage::CHALLENGE_PAGE_PUZZLE,      3,  4,  _S("[I_ZOMBIE_10]") },
	{ GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_ENDLESS,              11,  ChallengePage::CHALLENGE_PAGE_PUZZLE,      4,  0,  _S("[I_ZOMBIE_ENDLESS]") },
...
void ChallengeScreen::UpdateButtons()
{
	for (int aChallengeMode = 0; aChallengeMode < NUM_CHALLENGE_MODES; aChallengeMode++)
	{
		...
		aChallengeButton->mVisible = aChlDef.mPage == mPageIndex;
	}
...
int ChallengeScreen::AccomplishmentsNeeded(int theChallengeIndex)
{
	...
	if (mApp->IsSurvivalEndless(aGameMode) && aTrophiesNeeded <= 3 && mApp->GetNumTrophies(CHALLENGE_PAGE_SURVIVAL) < 14 &&
...
void ChallengeScreen::Draw(Graphics* g)
{
	...
	int aTrophiesTotal = mPageIndex == CHALLENGE_PAGE_SURVIVAL ? 14 : mPageIndex == CHALLENGE_PAGE_CHALLENGE ? 20 : mPageIndex == CHALLENGE_PAGE_PUZZLE ? 18 : 0;
	if (aTrophiesTotal > 0)
	{
...
void ChallengeScreen::Update()
{
	...
	if (mPageIndex == CHALLENGE_PAGE_SURVIVAL || mPageIndex == CHALLENGE_PAGE_PUZZLE || mPageIndex == CHALLENGE_PAGE_CHALLENGE)
	{
		mScrollPosition = ClampFloat(mScrollPosition += mScrollAmount * aScrollSpeed, 0, 1600); //amount of scroll
