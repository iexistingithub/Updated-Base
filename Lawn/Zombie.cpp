...
ZombieDefinition gZombieDefs[NUM_ZOMBIE_TYPES] = {  //0x69DA80
    { ZOMBIE_NORMAL,            REANIM_ZOMBIE,              1,      1,      1,      7000,   _S("ZOMBIE") ,0 },
    { ZOMBIE_FLAG,              REANIM_ZOMBIE,              1,      1,      1,      0,      _S("FLAG_ZOMBIE") ,0 },
    { ZOMBIE_TRAFFIC_CONE,      REANIM_ZOMBIE,              2,      2,      1,      6000,   _S("CONEHEAD_ZOMBIE") ,0 },
    { ZOMBIE_POLEVAULTER,       REANIM_POLEVAULTER,         2,      6,      5,      4000,   _S("POLE_VAULTING_ZOMBIE") ,0 },
    { ZOMBIE_PAIL,              REANIM_ZOMBIE,              4,      8,      1,      5000,   _S("BUCKETHEAD_ZOMBIE") ,0 },
    { ZOMBIE_NEWSPAPER,         REANIM_ZOMBIE_NEWSPAPER,    2,      5,     1,      4000,   _S("NEWSPAPER_ZOMBIE") ,0 },
    { ZOMBIE_DOOR,              REANIM_ZOMBIE,              4,      8,     5,      4000,   _S("SCREEN_DOOR_ZOMBIE") ,0 },
    { ZOMBIE_FOOTBALL,          REANIM_ZOMBIE_FOOTBALL,     7,      10,     5,      3000,   _S("FOOTBALL_ZOMBIE") ,0 },
    { ZOMBIE_DANCER,            REANIM_DANCER,              5,      18,     5,      2000,   _S("DANCING_ZOMBIE") ,0 },
    ...
    { ZOMBIE_SNORKEL,           REANIM_SNORKEL,             3,      23,     10,     3000,   _S("SNORKEL_ZOMBIE") ,0 },
    { ZOMBIE_ZAMBONI,           REANIM_ZOMBIE_ZAMBONI,      7,      26,     10,     3000,   _S("ZOMBONI") ,0 },
    { ZOMBIE_BOBSLED,           REANIM_BOBSLED,             3,      26,     10,     3000,   _S("ZOMBIE_BOBSLED_TEAM") ,0 },
    { ZOMBIE_DOLPHIN_RIDER,     REANIM_ZOMBIE_DOLPHINRIDER, 3,      28,     10,     2500,   _S("DOLPHIN_RIDER_ZOMBIE") ,0 },
    { ZOMBIE_JACK_IN_THE_BOX,   REANIM_JACKINTHEBOX,        3,      31,     10,     2000,   _S("JACK_IN_THE_BOX_ZOMBIE") ,0 },
    { ZOMBIE_BALLOON,           REANIM_BALLOON,             2,      33,     10,     3000,   _S("BALLOON_ZOMBIE") ,0 },
    { ZOMBIE_DIGGER,            REANIM_DIGGER,              4,      36,     10,     2000,   _S("DIGGER_ZOMBIE") ,0 },
    { ZOMBIE_POGO,              REANIM_POGO,                4,      38,     10,     2000,   _S("POGO_ZOMBIE") ,0 },
    { ZOMBIE_YETI,              REANIM_YETI,                4,      40,     1,      1,      _S("ZOMBIE_YETI") ,0 },
    { ZOMBIE_BUNGEE,            REANIM_BUNGEE,              3,      41,     10,     3000,   _S("BUNGEE_ZOMBIE") ,0 },
    { ZOMBIE_LADDER,            REANIM_LADDER,              4,      43,     10,     3000,   _S("LADDER_ZOMBIE") ,0 },
    { ZOMBIE_CATAPULT,          REANIM_CATAPULT,            5,      46,     10,     2500,   _S("CATAPULT_ZOMBIE") ,0 },
    { ZOMBIE_GARGANTUAR,        REANIM_GARGANTUAR,          10,     48,     10,     3000,   _S("GARGANTUAR") ,0 },
    { ZOMBIE_IMP,               REANIM_IMP,                 10,     1,      1,      7000,      _S("IMP") ,0 },
    { ZOMBIE_BOSS,              REANIM_BOSS,                10,     50,     1,      0,      _S("BOSS") ,0 },
    { ZOMBIE_PEA_HEAD,          REANIM_ZOMBIE,              1,      99,     1,      7000,   _S("PEASHOOTER_ZOMBIE") ,0 },
    { ZOMBIE_WALLNUT_HEAD,      REANIM_ZOMBIE,              4,      99,     1,      5000,   _S("WALLNUT_ZOMBIE") ,0 },
    { ZOMBIE_JALAPENO_HEAD,     REANIM_ZOMBIE,              3,      99,     10,     2000,   _S("JALAPENO_ZOMBIE") ,0 },
    { ZOMBIE_GATLING_HEAD,      REANIM_ZOMBIE,              3,      99,     10,     3000,   _S("GATLING_ZOMBIE") ,0 },
    { ZOMBIE_SQUASH_HEAD,       REANIM_ZOMBIE,              3,      99,     10,     4000,   _S("SQUASH_ZOMBIE") ,1 },
    { ZOMBIE_TALLNUT_HEAD,      REANIM_ZOMBIE,              4,      99,     10,     3000,   _S("TALLNUT_ZOMBIE") ,1 },
    { ZOMBIE_REDEYE_GARGANTUAR, REANIM_GARGANTUAR,          10,     48,     15,     3000,   _S("REDEYED_GARGANTUAR") ,1 },
    { ZOMBIE_TRASHCAN,          REANIM_ZOMBIE,              3,      7,     5,      4500,   _S("TRASH_CAN_ZOMBIE") ,1 },
    ...
    { ZOMBIE_IMPOSTOR,          REANIM_IMPOSTOR,                 10,     3,      1,      3000,      _S("IMPOSTOR") ,0 },
    { ZOMBIE_NINJAIMP,          REANIM_NINJAIMP,            2,      11,     1,      4000,   _S("NINJA_IMP") ,0 },
    { ZOMBIE_GARLIC_HEAD,       REANIM_ZOMBIE,               4,      99,     1,      4000,   _S("GARLIC_ZOMBIE") ,1 },
    { ZOMBIE_REPEATER_HEAD,     REANIM_ZOMBIE,              5,      99,     1,      4000,   _S("REPEATER_ZOMBIE") ,1 },
};
...
void Zombie::ZombieInitialize(int theRow, ZombieType theType, bool theVariant, Zombie* theParentZombie, int theFromWave)
{
    ...
    case ZombieType::ZOMBIE_MOUSTACHE:  //0x5227E9
        LoadPlainZombieReanim();
        EnableMustache(true);
        mBodyHealth = 500;
        if (Rand(2) == 0)
        ...
        break;
    case ZombieType::ZOMBIE_FIREFIGHTER:  //0x5227E9
        LoadPlainZombieReanim();
        mBodyHealth = 500;
        mHelmType = HelmType::HELMTYPE_FIREHELMET;
        mHelmHealth = 1000;
        break;

    case ZombieType::ZOMBIE_UMBRELLA:  //0x5227E9
        mBodyHealth = 1000;
        break;
    ...
    case ZombieType::ZOMBIE_FOOTBALL_GARG: //0x523D10
    {
        mWidth = 180;
        mHeight = 180;
        mBodyHealth = 3000;
        ...
        if (mZombieType == ZombieType::ZOMBIE_FOOTBALL_GARG)
        {
            aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_ZOMBIE_GARGANTUAR_HEAD_REDEYE);
            mBodyHealth = 9000;
        }
    ...
    case ZombieType::ZOMBIE_IMP:  //0x523576
        ...
        break;
    case ZombieType::ZOMBIE_BIGIMP:  //0x523576
        mScaleZombie = 1.5f;
        if (!IsOnBoard())
        {
            PlayZombieReanim("anim_walk", ReanimLoopType::REANIM_LOOP, 0, 12.0f);
    ...
    case ZombieType::ZOMBIE_IMPOSTOR:
        mZombiePhase = ZombiePhase::PHASE_ZOMBIE_NORMAL;
        mBodyHealth = 500;
        break;
            ...
            for (int x = 2; x < MAX_GRID_SIZE_X; x++)
            {
                ...
                for (int y = 0; y < MAX_GRID_SIZE_Y; y++)
                {
                    ...
                    if (aPlant)
                    {
                        ...
                        if (mApp->mGameMode == GAMEMODE_CHALLENGE_POGO_PARTY && aPlant->mSeedType == SEED_MAGNETSHROOM)
                        {
                            aWeight *= 50;
                        }
    ...
    case ZombieType::ZOMBIE_PEA_HEAD:  //0x52369B
    {
        ...
        aBodyReanim->mFrameBasePose = 0;
        TodScaleRotateTransformMatrix(aAttachEffect->mOffset, 58.0f, -13.0f, 0.2f, -1.0f, 1.0f);
    ...
    case ZombieType::ZOMBIE_WALLNUT_HEAD:  //0x523719
    {
        ...
        AttachEffect* aAttachEffect = AttachReanim(aTrackInstance->mAttachmentID, aHeadReanim, 0.0f, 0.0f);
        aBodyReanim->mFrameBasePose = 0;
        TodScaleRotateTransformMatrix(aAttachEffect->mOffset, 40.0f, -5.0f, 0.2f, -0.8f, 0.8f);
    ...
    case ZombieType::ZOMBIE_GARLIC_HEAD:  //0x52369B
    {
        LoadPlainZombieReanim();
        ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
        ReanimShowPrefix("anim_head2", RENDER_GROUP_HIDDEN);
    ...
    case ZombieType::ZOMBIE_REPEATER_HEAD:  //0x523ABA
    {
        LoadPlainZombieReanim();
        ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
        ReanimShowPrefix("anim_head2", RENDER_GROUP_HIDDEN);
...
void Zombie::PickRandomSpeed()
{
    ...
    else if (mZombieType == ZombieType::ZOMBIE_YETI || mZombieType == ZombieType::ZOMBIE_FIREFIGHTER)
    {
        mVelX = 0.4f;
    }
    else if (mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_BACKUP_DANCER || 
        mZombieType == ZombieType::ZOMBIE_POGO || mZombieType == ZombieType::ZOMBIE_FLAG || mZombieType == ZombieType::ZOMBIE_MOUSTACHE)
    {
        mVelX = 0.45f;
    }
...
void Zombie::UpdateZombieFootballer() {
    UpdateAnimSpeed();
...
void Zombie::BurnRow(int theRow)  // 此函数专用于在定义了 DO_FIX_BUGS 时修复火爆辣椒僵尸的 Bug
{
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        ...
        else if (aZombie->mZombieType == ZombieType::ZOMBIE_FIREFIGHTER)
        {
            return;
        }
    }
...
ZombieID Zombie::SummonImp(int theRow, int thePosX)
{
    if (!mBoard->RowCanHaveZombieType(theRow, ZombieType::ZOMBIE_IMP))
        return ZombieID::ZOMBIEID_NULL;

    Zombie* aZombie = mBoard->AddZombie(ZombieType::ZOMBIE_IMP, mFromWave);
    if (aZombie == nullptr)
        return ZombieID::ZOMBIEID_NULL;
    ...
    aZombie->mAltitude = ZOMBIE_BACKUP_DANCER_RISE_HEIGHT;
    aZombie->mZombiePhase = ZombiePhase::PHASE_IMP_LANDING;
    aZombie->mRelatedZombieID = mBoard->ZombieGetID(this);
...
ZombieID Zombie::SummonImp2(int theRow, int thePosX)
{
    if (!mBoard->RowCanHaveZombieType(theRow, ZombieType::ZOMBIE_IMP))
        return ZombieID::ZOMBIEID_NULL;
...
bool Zombie::CanLoseBodyParts()
{
    return 
        ...
        mZombieType != ZombieType::ZOMBIE_FOOTBALL_GARG &&
        mZombieType != ZombieType::ZOMBIE_IMPOSTOR &&
        mZombieHeight != ZombieHeight::HEIGHT_ZOMBIQUARIUM && 
        !IsFlying() && 
...
void Zombie::DropHead(unsigned int theDamageFlags)
{
    ...
    if (aParticle)
    {
        ...
        else if (mZombieType == ZombieType::ZOMBIE_IMP || mZombieType == ZombieType::ZOMBIE_BIGIMP || mZombieType == ZombieType::ZOMBIE_IMPOSTOR || mZombieType == ZombieType::ZOMBIE_NINJAIMP)
        {
...
void Zombie::UpdateZombieWalking()
{
    ...
    int Column = mBoard->PixelToGridX(mPosX, mPosY);


    Plant* aPlant = nullptr;
    // Loop over or check every plant
    while (mBoard->IteratePlants(aPlant)) {
        // check if the plant exists
        if (!aPlant) continue;

        if (
            // check if the plant is pochoclo
            aPlant->mSeedType == SEED_POPCORN &&
            (
                // check if the plant and the zombie are 2 blocks away
                (Column - aPlant->mPlantCol) <= 2) &&
            ((Column - aPlant->mPlantCol) > 0) &&
            // check if the plant is 1 tile away from the zombie vertically or row-wise
            abs(mRow - aPlant->mRow) == 1
            ) {
            // finally change the row if the above is true
            SetRow(aPlant->mRow);
        }
    }
...
void Zombie::Update()
{
    ...
    if (doUpdate)
    {
        ...
        if (mKnockBackCounter > 0.0f) 
        {
            mPosX += mKnockBackForce * mKnockBackDirection;
            mKnockBackCounter -= 0.1f;
        }
...
void Zombie::UpdateActions()
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_FOOTBALL_GARG)
    {
    ...
    if (mZombieType == ZombieType::ZOMBIE_IMP || mZombieType == ZombieType::ZOMBIE_BIGIMP || mZombieType == ZombieType::ZOMBIE_NINJAIMP)
    {
        UpdateZombieImp();
    }
    ...
    if (mZombieType == ZombieType::ZOMBIE_IMPOSTOR)
    {
        UpdateZombieImposter();
    }
}
...
void Zombie::CheckForBoardEdge()
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_POLEVAULTER || mZombieType == ZombieType::ZOMBIE_FOOTBALL_GARG)
    {
        aEdgeX = -150;
    }
...
void Zombie::KnockBackZombie(Zombie* theZombie, int theDirection, float theForce, float theTime) 
{
    theZombie->mKnockBackCounter = theTime;
    theZombie->mKnockBackDirection = theDirection;
    theZombie->mKnockBackForce = theForce;
...
void Zombie::UpdatePlaying()
{
    ...
    if (mPoisonCounter > 0)
    {
        ...
        {
            TakeDamage(20, DAMAGE_HITS_SHIELD_AND_BODY);
        }
    }
    if (mButteredCounter > 0)
    {
...
void Zombie::GetDrawPos(ZombieDrawPosition& theDrawPos)
{
    ...
    case ZombieType::ZOMBIE_GARGANTUAR:
    case ZombieType::ZOMBIE_REDEYE_GARGANTUAR:
    case ZombieType::ZOMBIE_FOOTBALL_GARG:
...
bool Zombie::CanTargetPlant(Plant* thePlant, ZombieAttackType theAttackType)
{
    ...
    if (theAttackType == ZombieAttackType::ATTACKTYPE_DRIVE_OVER)
    {
        if (thePlant->mSeedType == SeedType::SEED_CHERRYBOMB || thePlant->mSeedType == SeedType::SEED_JALAPENO || 
            thePlant->mSeedType == SeedType::SEED_BLOVER || thePlant->mSeedType == SeedType::SEED_SQUASH || thePlant->mSeedType == SeedType::SEED_BOMB)
        {
            return false;
        }
...
void Zombie::UpdateAnimSpeed()
{
    ...
    if (mIsEating)
    {
        if (mZombieType == ZombieType::ZOMBIE_POLEVAULTER || mZombieType == ZombieType::ZOMBIE_BALLOON || mZombieType == ZombieType::ZOMBIE_IMP || 
            ...
            mZombieType == ZombieType::ZOMBIE_YETI || mZombieType == ZombieType::ZOMBIE_NINJAIMP)
        {
            ApplyAnimRate(20.0f);
        }
        else
...
void Zombie::StartWalkAnim(int theBlendTime)
{
    ...
    else
    {
        ...
        {
            if (mZombieType == ZOMBIE_DOOR) //Optional     theBlendTime = 10;
...
void Zombie::EatPlant(Plant* thePlant)
{
    ...
    if (thePlant->mSeedType == SeedType::SEED_JALAPENO || 
        ...
        thePlant->mSeedType == SeedType::SEED_BOMB ||
    ...
    if (thePlant->mPlantHealth <= 0)
    {
        ...
        mBoard->mPlantsEaten++;
        if (thePlant->mSeedType == SeedType::SEED_EXPLODE_O_VINE || thePlant->mSeedType == SeedType::SEED_JALAPENO_NUT || thePlant->mSeedType == SeedType::SEED_WATERMELON_NUT || thePlant->mSeedType == SeedType::SEED_EXPLODE_O_NUT)
        {
            thePlant->DoSpecial();
        }
        else {
...
void Zombie::DieNoLoot()
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_IMPOSTOR)
    {
        ...
        else
        {
            ...
            Zombie* aZombie = mBoard->AddZombie(ZombieType::ZOMBIE_IMP, mFromWave);
            aZombie->mPosX = mPosX;
            aZombie->mPosY = GetPosYBasedOnRow(mRow);
            aZombie->SetRow(mRow);
            aZombie->mX = (int)aZombie->mPosX;
            aZombie->mY = (int)aZombie->mPosY;
            Zombie* aZombie2 = mBoard->AddZombie(ZombieType::ZOMBIE_IMP, mFromWave);
            aZombie2->mPosX = mPosX + 100;
            aZombie2->mPosY = GetPosYBasedOnRow(mRow);
            aZombie2->SetRow(mRow);
            aZombie2->mX = (int)aZombie->mPosX;
            aZombie2->mY = (int)aZombie->mPosY;
        }
    }
}
...
int Zombie::TakeShieldDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    if (aDamageIndexAfterDamage != aDamageIndexBeforeDamage)
    {
        ...
        unsigned int theDamageFlags = 0;

            int(mShieldType == ShieldType::SHIELDTYPE_DOOR && aDamageIndexAfterDamage == 1);
        {
            TOD_ASSERT(aBodyReanim);
            aBodyReanim->SetImageOverride("anim_screendoor", IMAGE_REANIM_ZOMBIE_SCREENDOOR2);
        }
           int(mShieldType == ShieldType::SHIELDTYPE_DOOR && aDamageIndexAfterDamage == 2);
        {
            TOD_ASSERT(aBodyReanim);
            aBodyReanim->SetImageOverride("anim_screendoor", IMAGE_REANIM_ZOMBIE_SCREENDOOR3);
        }
...
void Zombie::DropHelm(unsigned int theDamageFlags)
{
    ...
    else if (mHelmType == HelmType::HELMTYPE_FIREHELMET)
    {
        GetTrackPosition("anim_ZombieFire_helmet1", aPosX, aPosY);
        ReanimShowPrefix("anim_ZombieFire_helmet1", RENDER_GROUP_HIDDEN);
        ReanimShowPrefix("anim_hair", RENDER_GROUP_NORMAL);
        aEffect = ParticleEffect::PARTICLE_ZOMBIE_PAIL;
    }
...
int Zombie::TakeHelmDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    if (aDamageIndexBeforeDamage != aDamageIndexAfterDamage)
    {
        ...
        else if (mHelmType == HelmType::HELMTYPE_FIREHELMET && aDamageIndexAfterDamage == 1)
        {
            TOD_ASSERT(aBodyReanim);
            aBodyReanim->SetImageOverride("anim_ZombieFire_helmet1", IMAGE_REANIM_ZOMBIE_FIRE_HELMET2);
        }
        else if (mHelmType == HelmType::HELMTYPE_FIREHELMET && aDamageIndexAfterDamage == 2)
        {
            TOD_ASSERT(aBodyReanim);
            aBodyReanim->SetImageOverride("anim_ZombieFire_helmet1", IMAGE_REANIM_ZOMBIE_FIRE_HELMET3);
        }
...
void Zombie::TakeBodyDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    else if (mZombieType == ZombieType::ZOMBIE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_FOOTBALL_GARG)
    {
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
        if (aDamageIndexBeforeDamage != aDamageIndexAfterDamage)
        {
...
bool Zombie::ZombieTypeCanGoInPool(ZombieType theZombieType)
{
    return
        ...
        theZombieType == ZombieType::ZOMBIE_NINJAIMP ||
        ...
        theZombieType == ZombieType::ZOMBIE_FOOTBALL_GARG ||
        ...
        theZombieType == ZombieType::ZOMBIE_SQUASH_HEAD ||
        theZombieType == ZombieType::ZOMBIE_GARLIC_HEAD ||
        theZombieType == ZombieType::ZOMBIE_BIGIMP ||
        theZombieType == ZombieType::ZOMBIE_FIREFIGHTER ||
        theZombieType == ZombieType::ZOMBIE_REPEATER_HEAD;
}
...
bool Zombie::IsFireResistant()
{
    return 
        mZombieType == ZombieType::ZOMBIE_CATAPULT || 
        mZombieType == ZombieType::ZOMBIE_ZAMBONI || 
        mZombieType == ZombieType::ZOMBIE_FIREFIGHTER ||
        mShieldType == ShieldType::SHIELDTYPE_DOOR || 
        mShieldType == ShieldType::SHIELDTYPE_TRASHCAN ||
        mShieldType == ShieldType::SHIELDTYPE_LADDER;
}
...
void Zombie::ApplyBurn()
{
    ...
    if (mBodyHealth >= 1000 || mZombieType == ZombieType::ZOMBIE_FIREFIGHTER)
    {
        TakeDamage(10, 18U);
        return;
    }
    if (mBodyHealth >= 1350 || mZombieType == ZombieType::ZOMBIE_ZAMBONI)
    {
        TakeDamage(1350, 18U);
        return;
    }
    ...
    else if (mZombieType == ZOMBIE_BUNGEE || mZombieType == ZOMBIE_YETI || Zombie::IsZombotany(mZombieType) || IsBobsledTeamWithSled() || IsFlying() || !mHasHead || mZombieType == ZOMBIE_FIREFIGHTER)
    {
        SetAnimRate(0.0f);
        Reanimation* aHeadReanim = mApp->ReanimationTryToGet(mSpecialHeadReanimID);
        if (aHeadReanim)
    ...
    else
    {
        ...
        else if ((mZombieType == ZombieType::ZOMBIE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_FOOTBALL_GARG) && !mHasObject)
        {
...
void Zombie::PlayDeathAnim(unsigned int theDamageFlags)
{
    ...
    if (TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_DOESNT_LEAVE_BODY))
    {
        if (mZombieType != ZombieType::ZOMBIE_BOSS && mZombieType != ZombieType::ZOMBIE_GARGANTUAR && mZombieType != ZombieType::ZOMBIE_REDEYE_GARGANTUAR && mZombieType != ZombieType::ZOMBIE_FOOTBALL_GARG && mZombieType != ZombieType::ZOMBIE_FIREFIGHTER
)
        {
            DieNoLoot();
            return;
...
void Zombie::PreloadZombieResources(ZombieType theZombieType)
{
    ...
    else if (theZombieType == ZombieType::ZOMBIE_GARGANTUAR || theZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || theZombieType == ZombieType::ZOMBIE_FOOTBALL_GARG)
    {
...
void Zombie::UpdateZombieImposter()
{
    if (mZombiePhase = ZombiePhase::PHASE_ZOMBIE_NORMAL)
    {
        if (!mHasHead)
...
void Zombie::SummonImps()
{
    ...
    for (int i = 0; i < 1; i++)
    {
        if (mBoard->ZombieTryToGet(mFollowerZombieID[i]) == nullptr)
        {
            ...
            switch (i)
            {
            case 0:     aRow = mRow;        aPosX = mPosX;    break;
            default:    TOD_ASSERT();                               break;
            }

            mFollowerZombieID[i] = SummonImp(aRow, aPosX);
        }
    }
}
void Zombie::SummonImps2()
{
    if (!mHasHead)
        return;
    ...
    for (int i = 0; i < 1; i++)
    {
        if (mBoard->ZombieTryToGet(mFollowerZombieID[i]) == nullptr)
        {
            ...
            switch (i)
            {
            case 0:     aRow = mRow;        aPosX = mPosX = 100;    break;
            default:    TOD_ASSERT();                               break;
            }

            mFollowerZombieID[i] = SummonImp2(aRow, aPosX);
        }
    }
}