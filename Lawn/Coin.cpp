    ...
    else if (mType == CoinType::COIN_PRESENT_PLANT || mType == CoinType::COIN_AWARD_PRESENT)
    {
        ...
        else if (mBoard->mBackground == BackgroundType::BACKGROUND_8)
        {
            SeedType aSeedList[] = {
                ...
                SeedType::SEED_LOBELIA,
                SeedType::SEED_TOXIC_PEA,
                SeedType::SEED_EXPLODE_O_VINE,
                SeedType::SEED_ICY_BLOVER,
                SeedType::SEED_BELL_FLOWER,
                SeedType::SEED_POISONPOTATO,
                SeedType::SEED_POPCORN
            };
