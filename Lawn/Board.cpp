...
void Board::PickZombieWaves()
{
	...
	for (int aWave = 0; aWave < mNumWaves; aWave++)
	{
		...
		if (aIsFlagWave)
		{
			int aPlainZombiesNum = min(aZombiePoints, 10);
			aZombiePoints *= 3.0f;

			if (mApp->mGameMode != GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS && mApp->mGameMode != GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_2 && mApp->mGameMode != GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_3 && mApp->mGameMode != GameMode::GAMEMODE_CHALLENGE_PEAR)
			{
		...
		else if (mApp->IsLittleTroubleLevel() || mApp->IsWallnutBowlingLevel() || mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_PEAR)
		{
			aZombiePoints *= 4;
		}
		...
		else if (mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_PEAR)
		{
			aZombiePoints *= 6;
		}
		if (mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_BOH)
		{
			aZombiePoints *= 6;
		}
		if (mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS || GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_2 || GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_3)
		{
			aZombiePoints *= 3;
		}
...
void Board::LoadBackgroundImages()
{
	...
	case BackgroundType::BACKGROUND_8:
		TodLoadResources("DelayLoad_Background8");
		break;

	case BackgroundType::BACKGROUND_ALLPOOL:
		TodLoadResources("DelayLoad_BackgroundAllPool");
		break;

	case BackgroundType::BACKGROUND_9:
		TodLoadResources("DelayLoad_Background9");
		break;

	case BackgroundType::BACKGROUND_10:
		TodLoadResources("DelayLoad_Background10");
		break;
	case BackgroundType::BACKGROUND_11:
		TodLoadResources("DelayLoad_Background11");
		break;

	case BackgroundType::BACKGROUND_12:
...
void Board::PickBackground()
{
	...
	case GameMode::GAMEMODE_CHALLENGE_PURPLE:
	...
	case GameMode::GAMEMODE_CHALLENGE_ALL:
	case GameMode::GAMEMODE_CHALLENGE_ATHLETES:
		mBackground = BackgroundType::BACKGROUND_3_POOL;
		break;
	...
	case GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_3:
		mBackground = BackgroundType::BACKGROUND_ALLPOOL;
		break;
	...
	case GameMode::GAMEMODE_CHALLENGE_DOCKS:
		mBackground = BackgroundType::BACKGROUND_9;
		break;

	case GameMode::GAMEMODE_CHALLENGE_MOUNTAIN:
		mBackground = BackgroundType::BACKGROUND_10;
		break;

	case GameMode::GAMEMODE_CHALLENGE_BOH:
		mBackground = BackgroundType::BACKGROUND_11;
		break;

	case GameMode::GAMEMODE_CHALLENGE_RIVER:
	...
	else if (mBackground == BackgroundType::BACKGROUND_9)
	{
		mPlantRow[0] = PlantRowType::PLANTROW_POOL;
		mPlantRow[1] = PlantRowType::PLANTROW_NORMAL;
		mPlantRow[2] = PlantRowType::PLANTROW_NORMAL;
	...
	else if (mBackground == BackgroundType::BACKGROUND_10)
	{
	...
	else if (mBackground == BackgroundType::BACKGROUND_11)
	{
		...
		mGridSquareType[5][0] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[6][0] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[7][0] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[8][0] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[0][1] = GridSquareType::GRIDSQUARE_GRASS;
		...
		mGridSquareType[5][1] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[6][1] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[7][1] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[8][1] = GridSquareType::GRIDSQUARE_DIRT;
		...
		mGridSquareType[5][2] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[6][2] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[7][2] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[8][2] = GridSquareType::GRIDSQUARE_DIRT;
		...
		mGridSquareType[5][3] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[6][3] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[7][3] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[8][3] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[0][4] = GridSquareType::GRIDSQUARE_GRASS;
		...
		mGridSquareType[5][4] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[6][4] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[7][4] = GridSquareType::GRIDSQUARE_DIRT;
		mGridSquareType[8][4] = GridSquareType::GRIDSQUARE_DIRT;
		mPlantRow[5] = PlantRowType::PLANTROW_DIRT;
	}
	else if (mBackground == BackgroundType::BACKGROUND_12)
	{
		...
		mGridSquareType[3][0] = GridSquareType::GRIDSQUARE_GRASS;
		mGridSquareType[4][0] = GridSquareType::GRIDSQUARE_GRASS;
		mGridSquareType[5][0] = GridSquareType::GRIDSQUARE_GRASS;
		...
		mGridSquareType[6][3] = GridSquareType::GRIDSQUARE_GRASS;
		...
		mGridSquareType[3][4] = GridSquareType::GRIDSQUARE_GRASS;
		mGridSquareType[4][4] = GridSquareType::GRIDSQUARE_GRASS;
		mGridSquareType[5][4] = GridSquareType::GRIDSQUARE_GRASS;
		mGridSquareType[6][4] = GridSquareType::GRIDSQUARE_GRASS;
...
{
	if (mApp->IsWhackAZombieLevel() || mApp->IsSquirrelLevel() || (mApp->IsWallnutBowlingLevel() && !mApp->IsFirstTimeAdventureMode()))
	{
...
void Board::InitLevel()
{
	...
	else if (aGameMode == GameMode::GAMEMODE_CHALLENGE_GARG)
	{
		mSunMoney = 150;
	}
	...
	else if (aGameMode == GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_10)
	{
		...
		mSeedBank->mSeedPackets[1].SetPacketType(SeedType::SEED_ZOMBIE_POLEVAULTER);
		mSeedBank->mSeedPackets[2].SetPacketType(SeedType::SEED_ZOMBIE_FOOTBALL);
		mSeedBank->mSeedPackets[3].SetPacketType(SeedType::SEED_ZOMBIE_GIGA_FOOTBALL);
	}
	else if (aGameMode == GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_ENDLESS)
	{
		...
		mSeedBank->mSeedPackets[9].SetPacketType(SeedType::SEED_ZOMBIE_GIGA_FOOTBALL);
	}
	else if (mApp->IsScaryPotterLevel())
	{
	...
	else if (aGameMode == GameMode::GAMEMODE_CHALLENGE_DEEZNUTS)
	{
		...
		mSeedBank->mSeedPackets[0].SetPacketType(SeedType::SEED_WALLNUT);
		mSeedBank->mSeedPackets[1].SetPacketType(SeedType::SEED_TALLNUT);
		mSeedBank->mSeedPackets[2].SetPacketType(SeedType::SEED_JALAPENO_NUT);
		mSeedBank->mSeedPackets[3].SetPacketType(SeedType::SEED_WATERMELON_NUT);
		mSeedBank->mSeedPackets[4].SetPacketType(SeedType::SEED_EXPLODE_O_NUT);
		mSeedBank->mSeedPackets[5].SetPacketType(SeedType::SEED_GIANT_WALLNUT);
...
bool Board::ChooseSeedsOnCurrentLevel()
{
	...
	if (mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_ICE || 
		...
		mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_DEEZNUTS ||
...
Plant* Board::GetPumpkinAt(int theGridX, int theGridY)
{
	...
	{
		if (aPlant->mPlantCol == theGridX && aPlant->mRow == theGridY && !aPlant->NotOnGround() && aPlant->mSeedType == SeedType::SEED_PUMPKINSHELL || aPlant->mSeedType == SeedType::SEED_EXPLODE_O_VINE)
		{
			return aPlant;
		}
	}
...
void Board::GetPlantsOnLawn(int theGridX, int theGridY, PlantsOnLawn* thePlantOnLawn)
{
	...
	while (IteratePlants(aPlant))
	{
		...
		else if (aSeedType == SeedType::SEED_PUMPKINSHELL || aSeedType == SeedType::SEED_EXPLODE_O_VINE)
		{
...
PlantingReason Board::CanPlantAt(int theGridX, int theGridY, SeedType theSeedType)
{
	...
	if (theSeedType == SeedType::SEED_LILYPAD || theSeedType == SeedType::SEED_TANGLEKELP || theSeedType == SeedType::SEED_SEASHROOM || theSeedType == SeedType::SEED_SEA_TALL_NUT)
	{
		if (!IsPoolSquare(theGridX, theGridY))
		{
	...
	{
		if (!aNormalPlant || aNormalPlant->mSeedType != SeedType::SEED_CATTAIL || theSeedType != SeedType::SEED_PUMPKINSHELL || theSeedType != SeedType::SEED_EXPLODE_O_VINE)
		{
			return PlantingReason::PLANTING_NOT_ON_WATER;
		}
	}
	...
	if (mApp->mGameMode == GAMEMODE_CHALLENGE_DOCKS && (theGridY == 1 || theGridY == 2) && !aHasFlowerPot)
	{
		return PlantingReason::PLANTING_NEEDS_POT;
	}
	if (mApp->mGameMode == GAMEMODE_SURVIVAL_NORMAL_STAGE_8 && (theGridY == 1 || theGridY == 2) && !aHasFlowerPot)
	{
		return PlantingReason::PLANTING_NEEDS_POT;
	}
	if (mApp->mGameMode == GAMEMODE_SURVIVAL_HARD_STAGE_8 && (theGridY == 1 || theGridY == 2) && !aHasFlowerPot)
	{
		return PlantingReason::PLANTING_NEEDS_POT;
	}
	if (mApp->mGameMode == GAMEMODE_SURVIVAL_ENDLESS_STAGE_8 && (theGridY == 1 || theGridY == 2) && !aHasFlowerPot)
	{
		return PlantingReason::PLANTING_NEEDS_POT;
	}
	if (mApp->mGameMode == GAMEMODE_CHALLENGE_MOUNTAIN && (theGridY == 0 || theGridY == 1 || theGridY == 4 || theGridY == 5) && !aHasFlowerPot)
	{
		return PlantingReason::PLANTING_NEEDS_POT;
	}
	if (mApp->mGameMode == GAMEMODE_CHALLENGE_BOH && (theGridY == 2) && !aHasFlowerPot)
	{
		return PlantingReason::PLANTING_NEEDS_POT;
	}
	// 南瓜头的种植条件
	bool aAidPurchased = mApp->mPlayerInfo->mPurchases[StoreItem::STORE_ITEM_FIRSTAID] > 0;
	if (theSeedType == SeedType::SEED_PUMPKINSHELL || theSeedType == SeedType::SEED_EXPLODE_O_VINE )
	{
		// 不可种植在玉米加农炮上
		...
		if (aAidPurchased && aPumpkinPlant->mPlantHealth < aPumpkinPlant->mPlantMaxHealth * 2 / 3 &&
			aPumpkinPlant->mSeedType == SeedType::SEED_PUMPKINSHELL || aPumpkinPlant->mSeedType == SeedType::SEED_EXPLODE_O_VINE && aPumpkinPlant->mOnBungeeState != PlantOnBungeeState::GETTING_GRABBED_BY_BUNGEE)
		{
			return PlantingReason::PLANTING_OK;
		}
...
void Board::UpdateMousePosition()
{
	...
	else if (aCursorSeedType == SeedType::SEED_EXPLODE_O_VINE)
	{
		int aGridX = PlantingPixelToGridX(mApp->mWidgetManager->mLastMouseX, mApp->mWidgetManager->mLastMouseY, aCursorSeedType);
		int aGridY = PlantingPixelToGridY(mApp->mWidgetManager->mLastMouseX, mApp->mWidgetManager->mLastMouseY, aCursorSeedType);

		Plant* aPlant = GetTopPlantAt(aGridX, aGridY, PlantPriority::TOPPLANT_ONLY_NORMAL_POSITION);
		if (aPlant && aPlant->mSeedType == SeedType::SEED_EXPLODE_O_VINE && CanPlantAt(aGridX, aGridY, SeedType::SEED_EXPLODE_O_VINE) == PlantingReason::PLANTING_OK)
		{
			aPlant->mHighlighted = true;
		}
	}
...
void Board::UpdateToolTip()
{
	...
	else if (aUseSeedType == SeedType::SEED_ZOMBIE_GIGA_FOOTBALL)
	{
		mToolTip->SetLabel(_S("[GIGA_FOOTBALL_ZOMBIE]"));
	}
	else
	{
...
void Board::MouseDownWithPlant(int x, int y, int theClickCount)
{
	...
	if (mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_COLUMN)
	{
		for (int aRow = 0; aRow < MAX_GRID_SIZE_Y; aRow++)
		{
			...
			if (aPlantingSeedType == SeedType::SEED_PUMPKINSHELL || aPlantingSeedType == SeedType::SEED_EXPLODE_O_VINE)
			{
				aPumpkinPlant = GetTopPlantAt(aGridX, aRow, PlantPriority::TOPPLANT_ONLY_PUMPKIN);
				if (aPumpkinPlant && aPumpkinPlant->mSeedType == SeedType::SEED_PUMPKINSHELL || aPumpkinPlant && aPumpkinPlant->mSeedType == SeedType::SEED_EXPLODE_O_VINE)
				{
					aPumpkinPlant->Die();
				}
			}
...
Plant* Board::SpecialPlantHitTest(int x, int y)
{
	...
	while (IteratePlants(aPlant))
	{
		if (aPlant->mSeedType == SeedType::SEED_PUMPKINSHELL || aPlant->mSeedType == SeedType::SEED_EXPLODE_O_VINE)
		{
...
void Board::SpawnZombiesFromSky()
{
	...
	else if (mLevel == 43 || mLevel == 44 || mLevel == 45 || mLevel == 51 || mLevel == 52 || mLevel == 53 || mLevel == 54)
	{
		aCount = 3;
		aZombiePoints = 5;
	}
...
void Board::ZombiesWon(Zombie* theZombie)
{
	...
	while (IterateZombies(aZombie))
	{
		...
		{
			if ((aZombie->mZombieType == ZombieType::ZOMBIE_GARGANTUAR || aZombie->mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || aZombie->mZombieType == ZombieType::ZOMBIE_FOOTBALL_GARG) &&
...
void Board::UpdateSunSpawning()
{
	...
	if (mApp->mGameMode == GameMode::GAMEMODE_ADVENTURE)
	{
		...
		CoinType aSunType = mApp->mGameMode == GameMode::GAMEMODE_ADVENTURE ? CoinType::COIN_SMALLSUN : CoinType::COIN_SUN;
...
void Board::DrawBackdrop(Graphics* g)
{
	...
	case BackgroundType::BACKGROUND_8:				    aBgImage = Sexy::IMAGE_BACKGROUND8;                     break;
	case BackgroundType::BACKGROUND_ALLPOOL:		    aBgImage = Sexy::IMAGE_BACKGROUNDALLPOOL;               break;
	case BackgroundType::BACKGROUND_9:		            aBgImage = Sexy::IMAGE_BACKGROUND9;                     break;
...
void Board::DrawGameObjects(Graphics* g)
{
	...
	if (mApp->IsStormyNightLevel() || mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_RAINING_SEEDS || mApp->mGameMode == GameMode::GAMEMODE_ADVENTURE || mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_3)
	{
...
void Board::DrawHouseDoorTop(Graphics* g)
{
	...
	case BackgroundType::BACKGROUND_8:		    g->DrawImage(Sexy::IMAGE_BACKGROUND1_GAMEOVER_MASK, -130, 202);		break;
	case BackgroundType::BACKGROUND_ALLPOOL:    g->DrawImage(Sexy::IMAGE_BACKGROUND1_GAMEOVER_MASK, -130, 202);		break;
	default:																										break;
	}
}
...
void Board::KeyChar(SexyChar theChar)
{
	...
	if (mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS || mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_2 || mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_WAR_AND_PEAS_3)
	{
		...
		if (theChar == _S('d'))
		{
			AddZombie(ZombieType::ZOMBIE_GARLIC_HEAD, Zombie::ZOMBIE_WAVE_DEBUG);
			return;
		}
		if (theChar == _S('a'))
		{
		...
		if (mApp->IsSurvivalEndless(mApp->mGameMode))
		{
			...
			for (int y = 0; y < MAX_GRID_SIZE_X; y++)
			{
				for (int x = 0; x < MAX_GRID_SIZE_Y; x++)
				{
					...
					if (CanPlantAt(x, y, SeedType::SEED_EXPLODE_O_VINE) == PlantingReason::PLANTING_OK)
					{
						if (x <= 6 || IsPoolSquare(x, y))
						{
							AddPlant(x, y, SeedType::SEED_EXPLODE_O_VINE, SeedType::SEED_NONE);
						}
					}
...
int Board::GetNumSeedsInBank()
{
	...
	if (mApp->mGameMode == GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_5 || mApp->mGameMode == GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_6 ||
		mApp->mGameMode == GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_7 || mApp->mGameMode == GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_10)
	{
		return 4;
	}
	...
	if (mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_DEEZNUTS)
	{
		return 6;
	}
...
bool Board::StageHasGraveStones()
{
	if (mApp->IsWallnutBowlingLevel() ||
		...
		mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_BEGHOULED ||
		mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_BEGHOULED_TWIST ||
		mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_BOH ||
		mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_PORTAL_COMBAT ||
		mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_LAST_STAND ||
		mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_PURPLE ||
		mApp->IsIZombieLevel() ||
		mApp->IsScaryPotterLevel())
		return false;
