...
bool LawnApp::IsArtChallenge()
{
	...
	return 
		...
		mGameMode == GameMode::GAMEMODE_CHALLENGE_PURPLE ||
...
bool LawnApp::IsIZombieLevel()
{
	...
	return
		...
		mGameMode == GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_10 ||
...
bool LawnApp::HasSeedType(SeedType theSeedType)
{
	...
	*/
	...
	if (theSeedType == SeedType::SEED_JALAPENO_NUT || theSeedType == SeedType::SEED_WATERMELON_NUT || theSeedType == SeedType::SEED_SEA_TALL_NUT)
	{
		return mPlayerInfo->mPurchases[(int)StoreItem::STORE_ITEM_PLANT_LOBELIA] > 0;
	}
	...
	if (theSeedType == SeedType::SEED_BOMB || theSeedType == SeedType::SEED_SMAN)
	{
		return mPlayerInfo->mPurchases[(int)StoreItem::STORE_ITEM_PLANT_SOMETHING] > 0;
	}
