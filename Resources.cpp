...
bool Sexy::ExtractResourcesByName(ResourceManager *theManager, const char *theName)
{
	...
	if (strcmp(theName, "DelayLoad_Background12") == 0) return ExtractDelayLoad_Background12Resources(theManager);
	if (strcmp(theName, "DelayLoad_Background13") == 0) return ExtractDelayLoad_Background13Resources(theManager);
	if (strcmp(theName,"DelayLoad_BackgroundAllPool")==0) return ExtractDelayLoad_BackgroundAllPoolResources(theManager);
...
// DelayLoad_Background8 Resources
...
// DelayLoad_Background9 Resources
...
// DelayLoad_BackgroundAllPool Resources
Image* Sexy::IMAGE_BACKGROUNDALLPOOL;

bool Sexy::ExtractDelayLoad_BackgroundAllPoolResources(ResourceManager *theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUNDALLPOOL = aMgr.GetImageThrow("IMAGE_BACKGROUNDALLPOOL");
	}
	catch(ResourceManagerException&)
	{
		return false;
...
// DelayLoad_Background10 Resources
...
// DelayLoad_Background11 Resources
...
// DelayLoad_Background12 Resources
Image* Sexy::IMAGE_BACKGROUND12;

bool Sexy::ExtractDelayLoad_Background12Resources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUND12 = aMgr.GetImageThrow("IMAGE_BACKGROUND12");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
// DelayLoad_Background13 Resources
Image* Sexy::IMAGE_BACKGROUND13;

bool Sexy::ExtractDelayLoad_Background13Resources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUND13 = aMgr.GetImageThrow("IMAGE_BACKGROUND13");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_PROJECTILE_TOXIC;
Image* Sexy::IMAGE_PROJECTILE_LOBELIA;
Image* Sexy::IMAGE_PROJECTILE_SOUNDWAVE;
...
Image* Sexy::IMAGE_REANIM_PUMPKIN_DAMAGE2;
...
Image* Sexy::IMAGE_REANIM_ZOMBIE_FIRE_HELMET1;
Image* Sexy::IMAGE_REANIM_ZOMBIE_FIRE_HELMET2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_FIRE_HELMET3;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_PROJECTILE_TOXIC = aMgr.GetImageThrow("IMAGE_PROJECTILE_TOXIC");
		IMAGE_PROJECTILE_LOBELIA = aMgr.GetImageThrow("IMAGE_PROJECTILE_LOBELIA");
		IMAGE_PROJECTILE_SOUNDWAVE = aMgr.GetImageThrow("IMAGE_PROJECTILE_SOUNDWAVE");
		...
		IMAGE_REANIM_PUMPKIN_DAMAGE2 = aMgr.GetImageThrow("IMAGE_REANIM_PUMPKIN_DAMAGE2");
		...
		IMAGE_REANIM_ZOMBIE_FIRE_HELMET1 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_FIRE_HELMET1");
		IMAGE_REANIM_ZOMBIE_FIRE_HELMET2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_FIRE_HELMET2");
		IMAGE_REANIM_ZOMBIE_FIRE_HELMET3 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_FIRE_HELMET3");
...
static void* gResources[] =
{
	...
	&IMAGE_PROJECTILE_TOXIC,
	& IMAGE_PROJECTILE_LOBELIA,
	&IMAGE_SEEDBANK,
	...
	&IMAGE_REANIM_ZOMBIE_FIRE_HELMET1,
	&IMAGE_REANIM_ZOMBIE_FIRE_HELMET2,
	&IMAGE_REANIM_ZOMBIE_FIRE_HELMET3,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_PROJECTILE_TOXIC_ID: return "IMAGE_PROJECTILE_TOXIC";
		case IMAGE_PROJECTILE_LOBELIA_ID: return "IMAGE_PROJECTILE_LOBELIA";
		...
		case IMAGE_PROJECTILE_SOUNDWAVE_ID: return "IMAGE_PROJECTILE_SOUNDWAVE";
		...
		case IMAGE_REANIM_PUMPKIN_DAMAGE2_ID: return "IMAGE_REANIM_PUMPKIN_DAMAGE2";
		...
		case IMAGE_REANIM_ZOMBIE_FIRE_HELMET1_ID: return "IMAGE_REANIM_ZOMBIE_FIRE_HELMET1";
		case IMAGE_REANIM_ZOMBIE_FIRE_HELMET2_ID: return "IMAGE_REANIM_ZOMBIE_FIRE_HELMET2";
		case IMAGE_REANIM_ZOMBIE_FIRE_HELMET3_ID: return "IMAGE_REANIM_ZOMBIE_FIRE_HELMET3";
		...
		case IMAGE_BACKGROUNDALLPOOL_ID: return "IMAGE_BACKGROUNDALLPOOL";
		case IMAGE_BACKGROUND9_ID: return "IMAGE_BACKGROUND9";
		case IMAGE_BACKGROUND10_ID: return "IMAGE_BACKGROUND10";
		case IMAGE_BACKGROUND11_ID: return "IMAGE_BACKGROUND11";
		case IMAGE_BACKGROUND12_ID: return "IMAGE_BACKGROUND12";
		case IMAGE_BACKGROUND13_ID: return "IMAGE_BACKGROUND13";
