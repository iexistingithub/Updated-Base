...
enum GameMode
{
    ...
    GAMEMODE_CHALLENGE_DOCKS,
    GAMEMODE_CHALLENGE_GARG,
    GAMEMODE_CHALLENGE_ALL,
    GAMEMODE_CHALLENGE_PURPLE,
    GAMEMODE_CHALLENGE_MOUNTAIN,
    GAMEMODE_CHALLENGE_ATHLETES,
    GAMEMODE_CHALLENGE_DEEZNUTS,
    GAMEMODE_CHALLENGE_PEAR,
    GAMEMODE_CHALLENGE_BOH,
    GAMEMODE_CHALLENGE_RIVER,
    GAMEMODE_CHALLENGE_WORKERS,
...
enum ProjectileType
{
    ...
    PROJECTILE_LOBBED_PUFF = 14,
    PROJECTILE_LOBELIA_PETAL = 15,
    PROJECTILE_TOXIC_PEA = 16,
    PROJECTILE_SOUNDWAVE = 17,
    PROJECTILE_REDWAVE = 18,
    NUM_PROJECTILES = 19
};
...
enum SeedType
{
    ...
    SEED_SCAREDYSHROOM = 11,                  // 墓碑吞噬者
    SEED_HYPNOSHROOM = 12,                  // 魅惑菇
    SEED_GRAVEBUSTER = 13,                  // 胆小菇
    ...
    SEED_LOBELIA = 41,
    SEED_TOXIC_PEA = 42,
    SEED_EXPLODE_O_VINE = 43,
    SEED_ICY_BLOVER = 44,
    SEED_BELL_FLOWER = 45,
    SEED_POISONPOTATO = 46,
    SEED_POPCORN = 47,
    SEED_GATLINGPEA = 48,
    ...
    SEED_SPIKEROCK = 54,
    SEED_COBCANNON = 55,
    SEED_JALAPENO_NUT = 56,
    SEED_WATERMELON_NUT = 57,
    SEED_SEA_TALL_NUT = 58,
    SEED_BOMB = 59,
    SEED_SMAN = 60,
    SEED_IMITATER = 61,
    SEED_EXPLODE_O_NUT,
...
enum StoreItem
{
    ...
    STORE_ITEM_PLANT_LOBELIA,
    STORE_ITEM_PLANT_SOMETHING,
